The fork's repo is private at the moment. Request access or wait until it's made public again. Windows binaries of the cores are available as Release 1.0 in the base HVR88/vice-libretro repo for now: https://github.com/HVR88/vice-libretro/releases/tag/v1.0.0
